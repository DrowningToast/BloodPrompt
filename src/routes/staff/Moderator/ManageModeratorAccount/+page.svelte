<script lang="ts">
    import { Home, LogOut, Info, UserCircle, UserCircle2, KeyRound,MapPin, Lock } from 'lucide-svelte';
    ...
    <div class="flex flex-col items-center w-9/12">
        ...
        <div class="flex flex-row items-center justify-between px-16 h-32 w-full">
            <div class="flex flex-col">
                ...
                <p class="text-base text-gray-500">ในหน้านี้ผู้ดูเเลระบบสามารถจัดการข้อมูลบัญชี เเละเปลี่ยนรหัสผ่านได้</p>
            </div>
            <button class="flex justify-center items-center gap-2 bg-[#EF4444] rounded-full text-center h-12 w-60 px-12 py-4 text-base font-bold text-white">บันทึกข้อมูล</button>
        </div>
        <div class="flex flex-row justify-between bg-white rounded-3xl w-11/12 shadow-xl px-5 py-5">
            <div class="flex flex-col gap-4 w-8/12 px-5">
                ...
                <Input placeholder="ชื่อ-นามสกุล" class="rounded-lg border-2 border-gray-300 h-10 w-full px-4 py-4" />
                <Input placeholder="เบอร์โทรติดต่อ" class="rounded-lg border-2 border-gray-300 h-10 w-full px-4 py-4"/>
                <Input placeholder="อีเมล" class="rounded-lg border-2 border-gray-300 h-10 w-full px-4 py-4"/>
            </div>
            <div class="flex flex-col gap-4 w-8/12 px-5">
                <div class=" flex flex-row items-center gap-2">
                    <KeyRound class="w-6" />
                ...
                <Input placeholder="รหัสผ่านปัจจุบัน" class="rounded-lg border-2 border-gray-300 h-10 w-full px-4 py-4 "/>
                <Input placeholder="รหัสผ่านใหม่" class="rounded-lg border-2 border-gray-300 h-10 w-full px-4 py-4 "/>
                <Input placeholder="ยืนยันรหัสผ่านใหม่" class="rounded-lg border-2 border-gray-300 h-10 w-full px-4 py-4 "/>
            </div>
        </div>
    </div>
