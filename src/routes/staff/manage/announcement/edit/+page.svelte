    ...
    <div class="flex flex-col w-9/12 items-center h-full">
        ...
        <div class="flex flex-row items-center justify-between px-14 h-32 w-full">
            ...
            <div class="flex justify-between items-center gap-4">
                <Button class="flex justify-center gap-2 bg-[#EF4444] rounded-full text-center h-12 w-52 px-4 py-4 text-base font-bold text-white hover:bg-[#EF4444]"
                >
                    บันทึกข้อมูล
                </Button>

                <Button on:click={()=>{goto("/staff/manage/announcement")}} class="flex justify-center gap-2 bg-black rounded-full text-center h-12 w-60 px-12 py-4 text-base font-bold text-white">ยกเลิกการแก้ไข</Button>
            </div>
        </div>
