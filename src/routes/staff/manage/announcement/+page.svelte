<script lang="ts">
    ...
    import { Home, LogOut, CalendarDays, UserCircle, FileText, Gift, CalendarHeart, PlusCircle, Image, Info,Megaphone } from 'lucide-svelte';
    ...
    <div class="flex flex-col justify-center items-center w-9/12 h-auto">
        ...
        <div class="flex flex-row items-center justify-between px-14 h-32 w-full">
            ...
            <div class="flex justify-between items-center gap-4">
                <Button class="flex justify-center gap-1 bg-[#EF4444] rounded-full text-center h-12 w-72 px-4 py-4 pl-2 text-base font-bold text-white hover:bg-[#EF4444]" on:click={()=>{
                    if (browser) {
        ...
        <div class="flex justify-center items-center h-full w-full  py-2 gap-10">
            ...
            <div class="flex flex-col justify-start items-center h-full w-full pl-10 py-2 gap-10">
                <div class="flex flex-col justify-start gap-6 bg-white w-full h-fit rounded-3xl shadow-2xl px-10 py-10">
                    <div class="flex justify-between items-center w-full gap-5">
                        <div class="flex justify-start items-center gap-5">
                            <img src={bloodpromptlogo} alt="" class="h-14 w-14 border-2 border-gray-100 rounded-lg px-1 py-1">
                        ...
                        <Button class="flex justify-center items-center gap-1 bg-white rounded-full text-center h-10 w-20 px-4 py-4 text-base font-bold text-[#EF4444] hover:bg-white border-[#EF4444] border-2" on:click={()=>{
                            if (browser) {
                    ...
                    <p class="flex justify-start items-start text-base font-normal">
                        โรงพยาบาลราชวิถี ร่วมกับดีไซน์วิลเลจ จัดกิจกรรมรับบริจาคโลหิตครั้งที่ 2 ช่วยเหลือผู้ป่วยที่มีความต้องการโลหิตและเติมโลหิตคงคลัง
                        วันที่ 5 มีนาคม 2566 มีรายงานว่า ดีไซน์วิลเลจ เกษตร-นวมินทร์ ร่วมกับโรงพยาบาลราชวิถี 
                        จัดกิจกรรมดีต่อใจเปิดรับบริจาคโลหิต ครั้งที่ 2 เพื่อช่วยเหลือผู้ป่วยที่มีความต้องการโลหิตและเติมโลหิตคงคลังให้เพียงพอเพื่อไม่ให้ขาดแคลน ย้ำสโลแกนทุกคนเป็น Hero ได้ด้วยการบริจาคเลือด โดยกิจกรรมจัดขึ้นเมื่อวันที่ 27-28 กุมภาพันธ์ ที่ผ่านมา ณ บริเวณลาน ชั้น 1
                    </p>
                    <div class="flex rounded-xl justify-center">
                        <img src="https://static.thairath.co.th/media/Dtbezn3nNUxytg04aiKTuSDxWCQaz9s4h4yJIYnXoZKvJR.webp" alt="" class="rounded-2xl">
                    </div>
                </div>
                <div class="flex flex-col justify-start gap-6 bg-white w-full h-fit rounded-3xl shadow-2xl px-10 py-10">
                    <div class="flex justify-between items-center w-full gap-5">
