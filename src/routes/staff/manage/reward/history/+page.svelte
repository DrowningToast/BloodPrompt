			...
			<div class="flex flex-row gap-8 items-center mt-2">
				<Select.Root>
					...
					<Select.Content class="py-2">
						...
						<Select.Item value="tihsYear" class="py-2">ปีนี้</Select.Item>
					</Select.Content>
				</Select.Root>
				<Input placeholder="ระบุหมายเลขของรางวัล" class=" w-96 bg-white h-12 rounded-lg" />
				...
				<Table.Root>
					...
					<Table.Header>
						<Table.Row>
							...
							<Table.Head>Reward ID</Table.Head>
							<Table.Head>Reward Name</Table.Head>
							<Table.Head>Require Point</Table.Head>
					...
					<Table.Body>
						<Table.Row>
							...
							<Table.Cell>ศรุตา</Table.Cell>
							<Table.Cell>โทรัตน์</Table.Cell>
							<Table.Cell>51</Table.Cell>
							<Table.Cell>เงินดิจิทิล</Table.Cell>
							<Table.Cell>120 pts</Table.Cell>
							<Table.Cell>12/12/2023</Table.Cell>
							<Table.Cell>21:08 น.</Table.Cell>
							<Table.Cell
								><Dialog.Root>
										...
										<div class="flex flex-row mt-28 mx-5 gap-2 h-96">
											<div class=" basis-1/3 bg-white drop-shadow-md">
												...
												<div class="flex flex-col items-center justify-center mx-2 gap-3 mt-5">
													<div
														class="rounded-full bg-[#ef4444] w-28 h-28 flex items-center justify-center"
													>
														<User class="w-36 h-36 text-white " />
													</div>
													<div class=" flex items-center text-xl font-semibold">ศรุตา โทรัตน์</div>
													<div class="text-sm">
														Donator ID: <span class="font-semibold">9504</span>
													</div>
													<div class="flex flex-row gap-4">
														...
														<div class="text-sm font-semibold">0618245909</div>
													</div>
													<div class="flex flex-row gap-4">
														<svg
															xmlns="http://www.w3.org/2000/svg"
														...
														<div class="text-sm font-semibold">65070211@kmitl.ac.th</div>
													</div>
												</div>
											</div>
											<div class=" basis-2/3 bg-white drop-shadow-md">
												...
												<div class=" mx-8 my-8 flex">
													<div class="flex flex-col items-start justify-center w-1/2 gap-2">
														<div
															class="bg-[#CACACA] rounded-lg w-28 h-28 flex justify-center items-center"
														>
															<Wallet class="w-36 h-36 " />
														</div>
														<div class=" flex items-center text-xl font-semibold mt-1">
															เงินดิจิทัล 10000 บาท
														</div>
														<div class="">
															รหัสรางวัล: <span class="font-semibold">17943</span>
														</div>
														<div>
															ชื่อรางวัล:<span class="font-semibold">เงินดิจิทัล 10000 บาท</span>
														</div>
														<div>รายละเอียด:<span class="font-semibold">คนไทยมีกินมีใช้</span></div>
														<div>
															จำนวนคะแนนที่ใช้แลก:<span class="font-semibold"> 100 แต้ม</span>
														</div>
													</div>
													<div class="flex flex-col items-start justify-start w-1/2 gap-3">
														...
														<div class=" items-end flex justify-end w-full">
															<Button class=" w-28 h-12 text-base mt-10 rounded-full">ยืนยัน</Button
															>
														</div>
													</div>
												</div>
