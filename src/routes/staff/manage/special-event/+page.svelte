		...
		<div class="flex w-[1100px] h-[524px] bg-white rounded-[20px] mt-12 justify-between p-4">
			...
			<div class="flex flex-col w-1/2 gap-7">
				<div>
					...
					<p class="ml-7 mt-3">
						ดีพาร์ทเมนต์สลัมจีดีพีทอล์คดยุค แอพพริคอทฮิปฮอป วัจนะควีนสปอต เบนโลคาร์ รันเวย์บรา
						แพนด้า โอเปอเรเตอร์โซน ซานตาคลอสเด้อกัมมันตะวอเตอร์ ซิ่งบิล
						หลวงตาชินบัญชรว้อดก้าซาบะบึ้ม นาฏยศาลาจิตพิสัยหลินจือ อันเดอร์จิตพิสัยสตรอเบอร์รี
						สไตรค์ไทยแลนด์แกสโซฮอล์หยวน คอนโดมิเนียม ทอล์คลอร์ดสันทนาการ โรแมนติคซะดีพาร์ตเมนท์บูติก
						คอร์รัปชั่นฮิบรูศิรินทร์โยโย่ เที่ยงวันปาร์ตี้ออร์เดอร์
						เจ๊าะแจ๊ะไมค์มาร์เก็ตติ้งไคลแม็กซ์ สหัชญาณ โคโยตีเวสต์คอรัปชัน
						สัมนาสถาปัตย์ดีเจล็อบบี้แอปเปิล โอเปอเรเตอร์แคร็กเกอร์เทคโนแครตยอมรับโอยัวะ
						เสกสรรค์แทกติคมอลล์เลสเบี้ยนผู้นำ เยนโยเกิร์ต ละอ่อนแกงค์บุ๋น เคลียร์สะกอมอุด้งแชมเปี้ยน
						อันตรกิริยาเวสต์เซฟตี้ กรีนคอนเทนเนอร์ยิมซาตานเอ็นจีโอ
					</p>
				</div>
				<div class="flex flex-col">
					<p class="flex items-center gap-2 text-2xl font-bold">
						<CalendarClock />ระยะเวลาจัดกิจกรรม
					</p>
					<p class="font-bold pl-8">01/08/2023 08:00 - 12/08/2023 16:00</p>
				</div>
				<div class="flex justify-end gap-6 mt-auto">
					<Button
						class="flex self-center text-[#EF4444] border-[#EF4444] border-2 w-32 h-10 gap-1 bg-white hover:bg-white rounded-3xl"
						>แก้ไข</Button
					>
					<Button
						class="flex self-center text-white rounded-3xl w-32 h-10 gap-1 bg-[#EF4444] hover:bg-[#EF4444] rounded-3xls"
						>ลบ</Button
					>
				</div>
			</div>
