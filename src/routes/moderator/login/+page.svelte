    ...
    <div class=" w-1/2">
        <div class="pt-[45px] pl-[122px]">
            ...
            <div class="flex flex-col pt-12 gap-3">
                ...
                <p class="text-[#555] text-base">สำหรับบุคลากรการเเพทย์ กรุณาล็อกอินโดยใช้บัญชีผู้ใช้เเละรหัสผ่าน<br> ของสถานที่บริจาคเลือดที่ท่านรับผิดชอบ</p>
            </div>
            <!-- login -->
            <div class="w-[500px]">
                <!-- username -->
                <div class="pt-16 flex flex-col gap-3 ">
                    <p class="text-base font-bold pl-2">บัญชีผู้ใช้ (Username)</p>
                    <Input type="email" class="w-[500px] border-[3px] rounded-xl h-14" />
                </div>
